...
DISABLED: No diarization, no need for speakers
All endpoints are commented out.
"""

# DISABLED: Speaker management (no diarization, no need for speakers)
...
# DISABLED: All speaker endpoints (no diarization, no need for speakers)
